...
const slides: Slide[] = [
  {
    ...
    alt: "Phòng ở riêng tư ký túc xá Nấm's Dormitory Thủ Đức — căn hộ dịch vụ KTX cao cấp cho sinh viên",
  ...
  },
  {
    ...
    alt: "Giường ngủ khu KTX Nấm's Dormitory — chỗ ở sinh viên Thủ Đức gọn gàng, tiện nghi",
  ...
  },
  {
    ...
    alt: "Sinh hoạt chung ký túc xá Nấm's Dormitory — khu căn hộ dịch vụ sinh viên Thủ Đức",
  ...
  },
  {
    ...
    alt: "Nội thất KTX cao cấp Nấm's Dormitory — phòng trọ sinh viên Thủ Đức hiện đại, sạch sẽ",
  ...
  },
  {
    ...
    alt: "Tiện ích ký túc xá Nấm's Dormitory — máy lạnh, khu giặt, căn hộ dịch vụ trọn gói Thủ Đức",
  ...
  },
  {
    ...
    alt: "Góc học tập yên tĩnh Nấm's Dormitory — ký túc xá sinh viên và chỗ ở Thủ Đức",
  ...
  },
  {
    ...
    alt: "Không gian sống sạch sẽ Nấm's Dormitory — phòng trọ và KTX an toàn cho sinh viên Thủ Đức",
  ...
  },
  {
    ...
    alt: "Hình thực tế ký túc xá và căn hộ dịch vụ Nấm's Dormitory Thủ Đức — chất lượng hoàn thiện",
